...
<script src="/js/CmpAccountSignup.js" type="text/javascript"></script>
...
<input type="text" name="location" size="50"{if isset($quicky.server.GEOIP_CITY)} value="{$quicky.server.GEOIP_CITY|escape}"{/if} /></div><br class="clearfloat" /><br /><br />
...
<input type="password" name="password" size="50" autocomplete="off" /></div><br class="clearfloat" /><span class="capslock" style="display:none">Caps Lock</span><br /><br />
